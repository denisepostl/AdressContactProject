...
Für die Erstellung der Datenbank kann [create_database.py](https://github.com/denisepostl/AdressContactProject/tree/main/database/create_database.py) ausgeführt werden.
