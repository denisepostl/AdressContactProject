...
**Background** <br>
Wenn der Benutzer auf einen Button drückt, dann wird eine Funktion aufgerufen. Zum Beispiel will der Benutzer einen Kontakt hinzugefügen rufe ich eine Funktion auf
...
Und auch bei den anderen beiden Optionen: Kontakt-Löschen und Kontakt-Ändert funktioniert das navigieren in die jeweils anderen Optionen bzw. Windows gleich (sprich: über eine Funktion wird das jeweils andere Window aufgerufen). 
